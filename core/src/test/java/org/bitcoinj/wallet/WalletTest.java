...
public class WalletTest extends TestWithWallet {
    ...
    public void pubkeyOnlyScripts() throws Exception {
        ...
        assertTrue(t2.getInputs().get(0).getScriptSig().getChunks().get(0).getData().length > 50);
    }
    ...
    public void completeTxPartiallySignedMarried(Wallet.MissingSigsMode missSigMode, byte[] expectedSig) throws Exception {
        ...
        boolean firstSigIsMissing = Arrays.equals(expectedSig, input.getScriptSig().getChunks().get(1).getData());
        boolean secondSigIsMissing = Arrays.equals(expectedSig, input.getScriptSig().getChunks().get(2).getData());
        ...
        int length = input.getScriptSig().getChunks().get(localSigIndex).getData().length;
    ...
    public void completeTxPartiallySigned(Wallet.MissingSigsMode missSigMode, byte[] expectedSig) throws Exception {
        ...
        for (int i = 0; i < req.tx.getInputs().size(); i++) {
            ...
            if (input.getConnectedOutput().getParentTransaction().equals(t1)) {
                assertArrayEquals(expectedSig, input.getScriptSig().getChunks().get(0).getData());
